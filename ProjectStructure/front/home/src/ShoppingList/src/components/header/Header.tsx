...
export const Header = () => 
{
    ...
    return (
        <nav>
            ...
            <ul>
                <li className="homeShopping"><Link to="/">Home</Link></li>
                <li className="aboutShopping"><a href="#">About</a></li>
                <li className="contactShopping"><a href="#">Contact Us</a></li>
                ...
                <li className="dropdownShopping">
                    <div className="menuShopping"></div>
                    <div className="contentShopping">
                        <div className="homeHideShopping"><a href="#">Home</a></div>
                        ...
                        <div className="accountHideShopping"><a href="/#/account"><Button text={"Account"}/></a></div>
                    </div>   
                </li>
                <li className="regBtnShopping"><a href='/#/account'><Button text={"Account"}/></a></li> 
            </ul>                
        </nav>
    )
}
