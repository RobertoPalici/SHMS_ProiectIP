...
export const Header = () => 
{
    ...
    const clearNotifications = async () => {
        try {
            ...
            if (!response.ok) throw Error('Notifications could not be cle     ared');
            setNotifications([]);
        } catch (error) {
    ...
    return (
        <nav>
            <a href="#"><img src={require("../../../public/img/ico/Logo.png")} alt="logo" /></a>
            <ul>
                <li className="homeInventory"><Link to="/">Home</Link></li>
                <li className="aboutInventory"><a href="#">About</a></li>
                <li className="contactInventory"><a href="#">Contact Us</a></li>
                ...
                <li className="dropdownInventory">
                    <div className="menuInventory"></div>
                    <div className="contentInventory">
                        <div className="homeHideInventory"><a href="#">Home</a></div>
                        ...
                        <div className="accountHideInventory"><a href="/#/account"><Button text={"Account"}/></a></div>
                    </div>   
                </li>
                <li className="regBtnInventory"><a href='/#/account'><Button text={"Account"}/></a></li> 
            </ul>                
        </nav>
    )
}
